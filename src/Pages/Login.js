                    ...
                    <div className="mt-12 flex flex-col items-center">
                        ...
                        <div className="w-full flex-1 mt-8">
                            <div className="flex flex-col items-center">
                                ...
                                <button onClick={handleGitHubLogin} className="w-full max-w-xs font-bold shadow-sm rounded-lg py-3 bg-indigo-100 text-gray-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline mt-5">
                            ...
                            <div className="my-4 border-b text-center">
                                <div className="leading-none px-2 inline-block text-sm text-gray-600 tracking-wide font-medium bg-white transform translate-y-1/2">
                                    ...
                                    <Link to='/register' className="ml-2 text-indigo-500 hover:text-indigo-700 font-semibold">Register</Link>
                                </div>
                            </div>
                        </div>
                    </div>
